...
import { drawBus } from '../../graphics/sprites'
import { Player, VEHICLE_TAG } from '../Player'

export class Bus extends ex.Actor {
  ...
  onPreUpdate(engine: ex.Engine, _delta: number): void {
    ...
    // Sync player to roof of bus
    this.boardedPlayer.pos.x = this.pos.x
    this.boardedPlayer.pos.y = this.pos.y - 26
